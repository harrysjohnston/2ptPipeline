...
Just run ./run_tests.sh and expect to see a little plot of wg+, wgx, wgg for a small test sample, after about a minute of computation (16 threads). Should match the image in the repository.
